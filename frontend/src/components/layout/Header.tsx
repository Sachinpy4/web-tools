            ...
            <Link href="/" className="flex items-center space-x-2 group" onClick={closeMenu}>
              ...
              <div className="relative candy-logo-wrapper">
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-linear-to-tr from-white/30 to-transparent rounded-full candy-shine" />
                                  {/* Candy Icon */}
            ...
            <div className="relative group tools-dropdown-container">
              ...
              >
                <div className="p-2">
                  ...
                  <Link
                    href="/image/compress"
                    className={`group flex items-center px-3 py-3 rounded-xl text-sm font-medium transition-all duration-200 tool-link ${isActiveLink('/image/compress') ? 'bg-linear-to-r from-blue-50 to-indigo-50 dark:from-blue-950/50 dark:to-indigo-950/50 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-800' : 'hover:bg-linear-to-r hover:from-gray-50 hover:to-gray-100 dark:hover:from-gray-800 dark:hover:to-gray-750 text-gray-700 dark:text-gray-300'}`}
                    onClick={() => {
                      toggleToolsDropdown()
                      closeMenu()
                    }}
                  >
                    <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-linear-to-br from-blue-500 to-indigo-600 text-white mr-3 tool-icon">
                  ...
                  <Link
                    href="/image/resize"
                    className={`group flex items-center px-3 py-3 rounded-xl text-sm font-medium transition-all duration-200 tool-link ${isActiveLink('/image/resize') ? 'bg-linear-to-r from-green-50 to-emerald-50 dark:from-green-950/50 dark:to-emerald-950/50 text-green-700 dark:text-green-300 border border-green-200 dark:border-green-800' : 'hover:bg-linear-to-r hover:from-gray-50 hover:to-gray-100 dark:hover:from-gray-800 dark:hover:to-gray-750 text-gray-700 dark:text-gray-300'}`}
                    onClick={() => {
                      toggleToolsDropdown()
                      closeMenu()
                    }}
                  >
                    <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-linear-to-br from-green-500 to-emerald-600 text-white mr-3 tool-icon">
                  ...
                  <Link
                    href="/image/convert"
                    className={`group flex items-center px-3 py-3 rounded-xl text-sm font-medium transition-all duration-200 tool-link ${isActiveLink('/image/convert') ? 'bg-linear-to-r from-purple-50 to-violet-50 dark:from-purple-950/50 dark:to-violet-950/50 text-purple-700 dark:text-purple-300 border border-purple-200 dark:border-purple-800' : 'hover:bg-linear-to-r hover:from-gray-50 hover:to-gray-100 dark:hover:from-gray-800 dark:hover:to-gray-750 text-gray-700 dark:text-gray-300'}`}
                    onClick={() => {
                      toggleToolsDropdown()
                      closeMenu()
                    }}
                  >
                    <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-linear-to-br from-purple-500 to-violet-600 text-white mr-3 tool-icon">
                  ...
                  >
                    <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-linear-to-br from-orange-500 to-red-600 text-white mr-3 tool-icon">
                  ...
                  <Link
                    href="/image/metadata"
                    className={`group flex items-center px-3 py-3 rounded-xl text-sm font-medium transition-all duration-200 tool-link ${isActiveLink('/image/metadata') ? 'bg-linear-to-r from-cyan-50 to-blue-50 dark:from-cyan-950/50 dark:to-blue-950/50 text-cyan-700 dark:text-cyan-300 border border-cyan-200 dark:border-cyan-800' : 'hover:bg-linear-to-r hover:from-gray-50 hover:to-gray-100 dark:hover:from-gray-800 dark:hover:to-gray-750 text-gray-700 dark:text-gray-300'}`}
                    onClick={() => {
                      toggleToolsDropdown()
                      closeMenu()
                    }}
                  >
                    <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-linear-to-br from-cyan-500 to-blue-600 text-white mr-3 tool-icon">
