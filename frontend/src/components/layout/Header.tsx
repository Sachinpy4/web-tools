              ...
              >
                <div className="p-2">
                  ...
                  <Link
                    ...
                    className={`group flex items-center px-3 py-3 rounded-xl text-sm font-medium transition-all duration-200 tool-link ${isActiveLink('/image/background-removal') ? 'bg-gradient-to-r from-pink-50 to-rose-50 dark:from-pink-950/50 dark:to-rose-950/50 text-pink-700 dark:text-pink-300 border border-pink-200 dark:border-pink-800' : 'hover:bg-gradient-to-r hover:from-gray-50 hover:to-gray-100 dark:hover:from-gray-800 dark:hover:to-gray-750 text-gray-700 dark:text-gray-300'}`}
                    onClick={() => {
                      toggleToolsDropdown()
                      closeMenu()
                    }}
                  >
                    <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-gradient-to-br from-pink-500 to-rose-600 text-white mr-3 tool-icon">
